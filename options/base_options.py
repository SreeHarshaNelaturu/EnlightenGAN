...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='/home/harsha/Documents/runway_projects/enlighten/EnlightenGAN/checkpoints/', help='models are saved here')
