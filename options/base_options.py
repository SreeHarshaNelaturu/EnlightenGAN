...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--which_model_netD', type=str, default='basic', help='selects model  use for netD')
        ...
        self.parser.add_argument('--self_attention', type=bool, default=True, help='ladida')
